...
(1, 'iddi', 'amin', 'idd.amin@example.com', '136 MUST\r\n', 'Dar es Salaam', '+255 700 123456', '1990-08-15', 'drinking some pure water\r\n'),
(2, 'mfaume', 'kawawa', 'mfaumekawawa@example.com', '563  Ariana', 'Zanzibar', '+255 777 987654', '1985-03-20', 'rice\r\n'),
(3, 'mwantumu', 'musa', 'mwantumumusa@example.com', '768 AVIENNA', 'Arusha', '+255 787 654321', '1978-11-10', 'soup'),
(4, 'Rwiza', 'waitara', 'rwizawaitara@example.com', '900 Gengeni', 'Dodoma', '+255 716 111222', '1988-06-25', 'stip'),
(5, 'abraham', 'linken', 'abrahamlinken@example.com', '366 kweko', 'Mwanza', '+255 754 333444', '1995-01-03', 'angelos\r\n'),
(6, 'aneth', 'dawas', 'anetdawas@example.com', '987 easl', 'Morogoro', '+255 783 556677', '1983-09-18', 'Pilipili Chicken'),
(7, 'hassan', 'Mazembe', 'hassanmazembe@example.com', '748 yel', 'Mbeya', '+255 767 778899', '1990-12-30', 'Matoke'),
...
(15, 'mwazonge', 'wlliam', 'mwazongewilliam@example.com', '670 yhom', 'Temeke', '+255 767 334455', '1987-09-14', 'Wali Na Kuku'),
(16, 'Juma', 'Omar', 'juma.omar@example.com', '369 Buguruni St', 'Ilala', '+255 713 556677', '1995-05-22', 'Supu Ya Ndizi'),
